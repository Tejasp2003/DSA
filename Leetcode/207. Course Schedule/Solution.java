...
class Solution {
    public boolean canFinish(int numCourses, int[][] prerequisites) {
        ...
        // Create an array to keep track of the indegree of each course (number of
        // incoming edges)
        ...
        // Use a breadth-first search to traverse the graph and find the topological
        // order
        while (!q.isEmpty()) {
            int node = q.peek();
            q.remove();
        ...
        // If we can't find a topological order (i.e. the length of the topo array is
        // less than the number of courses), return false
